...
CREATE TABLE `equipe` (
  ...
  CONSTRAINT `equipe_ibfk_2` FOREIGN KEY (`id_funcionario_equipe`) REFERENCES `funcionario` (`id_funcionario`)
...
INSERT INTO `equipe` VALUES (1,1,1),(2,2,2);
...
CREATE TABLE `funcionario` (
  ...
  `Local_trabalho_funcionario` varchar(50) DEFAULT NULL,
...
INSERT INTO `funcionario` VALUES (1,'Ronnaldo',999999999,'--','Ronaldo@gmail.com','2024-10-19','Gerente'),(2,'Barbara',999999998,'--','Barbara@gmail.com','2024-10-18','Vice_gerente');
...
INSERT INTO `instrutor` VALUES (1,'Cristiano'),(2,'Ronaldo');
...
INSERT INTO `treinamento` VALUES (1,'Rua_travessa jose veloso','Segurança','0000-00-00','0000-00-00',NULL,NULL),(2,'Rua_travessa jose veloso','Segurança','0000-00-00','0000-00-00',NULL,NULL),(3,'Rua_travessa jose veloso','Segurança','2024-10-19','2024-10-25',NULL,NULL),(4,'Rua_travessa jose veloso','Segurança','2024-10-19','2024-10-25',NULL,NULL);
...
-- Dump completed on 2024-10-19 12:32:22
